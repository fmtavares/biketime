...
export function OSFormDialog({
  ...
  /** Preview/impressão do comprovante 76×96mm da OS. */
  ...
  /**
   * Monta os dados do comprovante 76×96mm a partir da OS persistida.
   */
  ...
  /**
   * Salva a OS (gera número se nova) e abre o comprovante 76×96mm para impressão.
   */
