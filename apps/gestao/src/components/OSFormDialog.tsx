...
export function OSFormDialog({
  ...
  /** Preview/impressão do comprovante 80×100mm da OS. */
  ...
  /**
   * Monta os dados do comprovante 80×100mm a partir da OS persistida.
   */
  ...
  /**
   * Salva a OS (gera número se nova) e abre o comprovante 80×100mm para impressão.
   */
