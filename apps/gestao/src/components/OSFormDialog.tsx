...
export function OSFormDialog({
  ...
  /** Preview/impressão do comprovante 98×78mm da OS. */
  ...
  /**
   * Monta os dados do comprovante 98×78mm a partir da OS persistida.
   */
  ...
  /**
   * Salva a OS (gera número se nova) e abre o comprovante 98×78mm para impressão.
   */
