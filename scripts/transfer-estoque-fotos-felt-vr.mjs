/**
 * Transfere fotos das Felt VR (estoque) do Lovable → Site Bike Time
 * e atualiza as URLs públicas em bikes_estoque.
 *
 * Uso: node scripts/transfer-estoque-fotos-felt-vr.mjs
 */
...
const BIKES = [
  {
    id: "79fab19e-4cef-418f-b803-51a11b645cdb",
    label: "Felt VR Advanced 105 Mecanico",
  },
  {
    id: "dfd99179-f33f-4f69-bb7d-fa3bc6d8da75",
    label: "Felt VR Advanced 105 Di2",
  },
  {
    id: "28ef60a4-41d5-41bc-8950-02b849d1d7d7",
    label: "Felt VR 60 Tiagra",
  },
];
