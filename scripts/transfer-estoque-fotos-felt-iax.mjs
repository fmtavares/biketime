/**
 * Transfere fotos das Felt IAx (estoque) do Lovable → Site Bike Time
 * e atualiza as URLs públicas em bikes_estoque.
 *
 * Uso: node scripts/transfer-estoque-fotos-felt-iax.mjs
 */
...
/** Bikes alvo + campos de URL a reescrever. */
const BIKES = [
  {
    id: "f44d1248-6d03-444f-a9ee-a933193262e3",
    label: "Felt Iax Advanced 105 Di2",
  },
  {
    id: "34b52f3e-c273-4f6a-b7a5-1c45cc9f09b0",
    label: "Felt Iax Advanced 105 Mecanico",
  },
  {
    id: "d31a8b51-7501-48dd-96a7-92a5f4726797",
    label: "Felt Iax Advanced Ultegra Di2",
  },
];
...
async function main() {
  ...
  for (const bike of BIKES) {
    ...
    // Atualiza URLs no banco do destino
    ...
    if (Array.isArray(row.fotos) && row.fotos.length) {
      // campo fotos não está no select tipado acima — ignorado se vazio
    }
