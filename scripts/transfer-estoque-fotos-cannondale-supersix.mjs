/**
 * Transfere fotos da Cannondale SuperSix 3 (estoque) do Lovable → Site Bike Time
 * e atualiza as URLs públicas em bikes_estoque.
 *
 * Uso: node scripts/transfer-estoque-fotos-cannondale-supersix.mjs
 */
...
const BIKES = [
  {
    id: "c4c187c4-d892-4b4b-863a-616e6c5758cf",
    label: "Cannondale SuperSix 3",
  },
];
